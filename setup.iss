...
; \qt5\5.15.2\mingw81_32\bin\windeployqt.exe CertInfo.exe  --qmldir \Users\user\git\CertInfo\src\
...
Source: "C:\Users\user\git\build-CertInfo-Desktop_Qt_5_15_2_MinGW_32_bit-Release\release\*"; DestDir: "{app}"; Excludes: "*.cpp,*.o,moc*"; Flags: ignoreversion recursesubdirs createallsubdirs
